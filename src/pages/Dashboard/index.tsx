...
import BarChartComponent from "../../components/BarChartComponent/indes";
...
const Dashboard: React.FC = () => {
    ...
    const relationExpensivesRecurrentVesusEventual = useMemo(() => {
    ...
    return (
        <Container>
            ...
            <Content>
                ...
                <BarChartComponent
                    title="Saídas"
                    data={relationExpensivesRecurrentVesusEventual}
                />
